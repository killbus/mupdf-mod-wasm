...
export declare class PDFDocument extends Document {
     ...
     * ```
     */
    saveToBufferStreaming(onChunk: (chunk: Uint8Array | null) => void, options?: string | Record<string, any>): number;
...
declare global {
    function $libmupdf_streaming_callback(callbackId: number, dataPtr: Pointer<"char">, size: number): void;
}
