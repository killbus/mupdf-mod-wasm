...
[![Build MuPDF WASM](https://github.com/killbus/mupdf-mod-wasm/actions/workflows/build.yml/badge.svg)](https://github.com/killbus/mupdf-mod-wasm/actions/workflows/build.yml)
[![Latest Release](https://img.shields.io/github/v/release/killbus/mupdf-mod-wasm)](https://github.com/killbus/mupdf-mod-wasm/releases)
...
Builds are automatically triggered **weekly** and published as versioned **[GitHub Releases](https://github.com/killbus/mupdf-mod-wasm/releases)**.
...
pnpm add mupdf@github:killbus/mupdf-mod-wasm#v1.25.0

# OR Install from the rolling stable branch
pnpm add mupdf@github:killbus/mupdf-mod-wasm#release
```
...
pnpm add mupdf@github:killbus/mupdf-mod-wasm#v1.26.0-rc1

# OR Install from the rolling beta branch
pnpm add mupdf@github:killbus/mupdf-mod-wasm#release-beta
```
...
pnpm add mupdf@github:killbus/mupdf-mod-wasm#nightly-2025.12.08-0bf523c

# OR Install from the rolling nightly branch
pnpm add mupdf@github:killbus/mupdf-mod-wasm#release-nightly
```
